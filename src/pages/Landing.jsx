                  ...
                  <Rv key={i} delay={i * 0.07}>
                    <div style={{ paddingLeft: 22, borderLeft: '2px solid rgba(196,160,160,0.15)' }}>
                      <p style={{ fontSize: 16, fontWeight: 300, color: C.textFaint, lineHeight: 1.7 }}>
                        <span style={{ textDecoration: 'line-through', textDecorationColor: 'transparent', color: 'rgba(180,150,140,0.5)', backgroundImage: 'linear-gradient(90deg, #c4a0a0, #a48bc4, #8cb4c8, #7eb89a, #d4a574)', WebkitTextDecorationColor: 'transparent', textDecorationSkipInk: 'none' }}>
                          <span style={{ textDecoration: 'line-through', textDecorationColor: '#a48bc4', textDecorationThickness: 2 }}>{problem}</span>
                        </span>{' '}
