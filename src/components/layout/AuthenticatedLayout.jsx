...
import { CommandMenuProvider, useCommandMenu } from './CommandMenuContext';
import { Toaster } from 'sonner';
import GlobalAiChat, { GlobalAiChatProvider } from '../ai/GlobalAiChat';
    ...
    <RequireAuth>
      <div className="min-h-screen bg-[#F4F4F6] flex font-sans text-[#333333]">
        ...
        <main className="flex-1 min-w-0 overflow-y-auto h-[100dvh] p-4 md:p-6 relative">
          ...
          <div className="w-full max-w-[1400px] mx-auto bg-white rounded-2xl min-h-[calc(100dvh-3rem)] overflow-hidden">
            {children}
          </div>
        </main>
