      ...
      <div className="flex-1 overflow-y-auto p-6">
        <div className="max-w-2xl mx-auto space-y-2">
          {timeSlots.map((slot, idx) => {
              ...
              return (
                <div 
                  ...
                  className={`flex items-center gap-4 p-4 rounded-xl transition-all ${
                    shouldHighlightGap ? 'ring-2 ring-gray-400' : ''
                  }`}
                  style={{ 
                    backgroundColor: shouldHighlightGap ? 'rgba(200, 200, 200, 0.1)' : 'transparent',
                  }}
                >
                  ...
                  <div 
                    className="flex-1 py-3 px-4 rounded-xl border-2 border-dashed"
                    style={{ borderColor: 'rgba(200, 160, 160, 0.3)' }}
                  >
                    <span className="text-sm" style={{ color: colors.muted }}>(empty)</span>
                  </div>
                </div>
              );
            }
            ...
            const capacity = 15; // Default capacity
